...
<<<<<<< HEAD
type RESTPostAPIBaseApplicationCommandsJSONBody = AddUndefinedToPossiblyUndefinedPropertiesOfInterface<Omit<APIApplicationCommand, 'application_id' | 'default_member_permissions' | 'description_localized' | 'description' | 'guild_id' | 'id' | 'name_localized' | 'type' | 'version'> & Partial<Pick<APIApplicationCommand, 'default_member_permissions'>>>;
=======
