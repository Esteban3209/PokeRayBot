 ...
 */
<<<<<<< HEAD
export type APIGuildCreatePartialChannel = StrictPartial<Pick<UnionToIntersection<APIGuildChannelResolvable>, 'bitrate' | 'nsfw' | 'rate_limit_per_user' | 'topic' | 'type' | 'user_limit'>> & {
=======
